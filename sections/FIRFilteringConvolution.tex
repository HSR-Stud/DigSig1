...
out of the input signal. The filter matrix $H$, respectivly the signal matrix $X$, must be rectangular with dimensions
\[
...
\subsubsection{Transient and Steady-State Behavior\buchSeite{132,133}}
\begin{multicols}{2}
\begin{tabular}{|l|l|}
	\hline
...
\subsubsection{Hardware realizations and circualr buffers \buchSeite{162}}